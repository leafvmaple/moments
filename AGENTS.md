...
- ❌ wiki 起手的史实空降。
- ❌ 把同行者写成主角、写人脸、写大段对话。
- ❌ **同一个「签名动词」反复用** —— 头号惯犯是「压」（落日「压到水面上」、云「压下来」、建筑「压过来」、连菜都「压一坨」）。写「逼近 / 沉落 / 笼罩 / 铺满」这类意象时，第二次想伸手够同一个动词就**换掉**：塞满、撞进、坠、沉、贴、垂、罩、堆、扣……一篇里同一个动词担同一种活儿别超过一次。这是显得"词汇匮乏"的最大来源，写完扫一遍高频动词。
